...
to our hosting provider (Netlify, Inc.) will be collected, especially to ensure a secure and
...
The data will be deleted within no more than thirty days, unless continued
...
More information about the processing at the hosting provider Netlify, Inc. is
provided in their [privacy policy (https://www.netlify.com/privacy/)](https://www.netlify.com/privacy/) and
[GDPR page (https://www.netlify.com/gdpr-ccpa/)](https://www.netlify.com/gdpr-ccpa/).
...
{<p>
The "Terms of Service" provided by Mapbox at

  <a href="https://www.mapbox.com/tos/#maps" target="_blank" rel="noopener">
    https://www.mapbox.com/tos/#maps
  </a>
  ontain further information about the use of Mapbox and the data obtained by
  Mapbox.
</p>}
