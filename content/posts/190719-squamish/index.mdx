...
There I try to climb High Boltage Line (<Grade system="YDS" value="5.10a" />). It has a high first bolt (get
...
Next we set up a top rope on Foot in the Gravy (<Grade system="YDS" value="5.10d" />), a short slab climb with
...
Christine such as Dusty Eyes (<Grade system="YDS" value="5.4" />). The Alexis Cracks (<Grade system="YDS" value="5.7" />), and Libya Sucks
(<Grade system="YDS" value="5.7" />). It was fun to do some laybacking, hand jamming, and foot jamming in those
cracks. Those are moves you rarely get on sport climbs.

<Rimg src="3.jpg">
  The Alexis Cracks (<Grade system="YDS" value="5.7" />)
</Rimg>
