...
<Gallery>
  ...
  <Rimg
    src="37.jpg"
    caption="Here you get a little bit of an impression of the steepness."
  />
  <Rimg
    src="38.jpg"
    caption="Fabian getting ahead. Can you see the airplane?"
  />
...
<Pano
  src="40.jpg"
  caption="… before we can enjoy the amazing view of the Alps."
/>
...
<Gallery>
  <Rimg
    src="45.jpg"
    alt="Taking of the snow shoes for a break at a patch of snow free grass."
  />
...
<Gallery>
  ...
  <Rimg
    src="49.jpg"
    caption="We made it back to the Pleisenhütte, but we only descended half of the elevation."
  />
  <Rimg
    src="50.jpg"
    caption="About an hour before we reach Scharnitz, we pass this small stream which allows us to refill our water with some well tasting water."
  />
  <Rimg
    src="51.jpg"
    caption="Back to the Isar and the last couple of meters before reaching Scharnitz."
  />
