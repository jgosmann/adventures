...
<Loc latlong={[49.9878, -123.3116]} zoom={9} />
...
We warm up on the fun routes Domestic Disturbance (<Grade system="YDS" value="5.10a" />) and Flypaper (<Grade system="YDS" value="5.10c" />).
Then we try the really great (top 100) Under the Influence (<Grade system="YDS" value="5.11a" />). I almost
...
think a little bit. Our final route for the day is Upchuck (<Grade system="YDS" value="5.11b" />) which is
...
<Gallery>
  ...
  <Rimg
    src="2.jpg"
    caption="Christine heading back down at the start of Stairway to Heaven"
  />
</Gallery>

<Rimg
  src="1.jpg"
  caption="The start of the route already gives a nice view of Howe Sound"
/>
