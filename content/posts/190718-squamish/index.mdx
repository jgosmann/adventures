...
<Loc latlong={[49.9354914, -123.1576047]} zoom={11} />
...
<Rimg
  src="4.jpg"
  caption="Are these the cliffs we are looking for? We figure out later, yes they are. The route is on the left-most part."
/>
...
<Rimg
  src="19.jpg"
  caption="This must be the first major switch back!  (Looking back to where we came from.)"
/>
...
<Rimg
  src="7.jpg"
  caption="The boulder field tells us that we are almost there"
/>
...
again. So we decide to start the climb. I lead the first pitch (<Grade system="YDS" value="5.10a" />). Indeed
...
Vera leads the second pitch (<Grade system="YDS" value="5.8" />) which is scrambling for the most part. Then
I am back to leading. Pitch 3 (<Grade system="YDS" value="5.10b" />) starts steep, has a slabby crux and is
sustained. Pitch 4 (<Grade system="YDS" value="5.10c" />) is the crux pitch. First you have to pull from under
...
6 (both <Grade system="YDS" value="5.10a" />) bring more slab climbing and some more light and short rain
