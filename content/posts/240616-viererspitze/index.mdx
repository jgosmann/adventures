...
how fast the chamois manage to run over it. But luckily it isn't as bad as
[last year at the Breitenkopf](/posts/230611-breitenkopf/). There are
...
that it is harder than the [Hohe Gaif](/posts/210807-hoher-gaif/), the route finding can be a bit tricky, and supposedly it is quite
