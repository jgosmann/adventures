...
above the Cheakamus river. With a crux pitch of <Grade system="YDS" value="5.9" />, it is easy climbing, but
...
<Gallery>
  <Rimg src="11.jpg" caption="Me starting the first pitch" />
...
There we look for another top 100 climb, Rocky Horror (<Grade system="YDS" value="5.10b" />). But
...
To finish the day off, we do Attachment Theory another really fun <Grade system="YDS" value="5.10b" />.
