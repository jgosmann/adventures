...
first pitch Women in Comfortable Shoes (<Grade system="YDS" value="5.10a" />) between 6am and 7am. It is
...
<Rimg
  src="IMG_20190715_090556.jpg"
  caption="Start of the first pitch following a dyke"
/>

The second pitch (<Grade system="YDS" value="5.10a" />) moves upwards, first on a layback crack, but then
...
<Gallery>
  <Rimg
    src="7.jpg"
    caption="Vera at the first anchor after I climbed the first few meters of the second pitch"
  />
...
pitches (<Grade system="YDS" value="5.10c" />) awaits. At least with reasonable bolt distances. Nevertheless,
...
Another easier (<Grade system="YDS" value="5.10a" />) pitch follows. After traversing another dyke, it brings
...
climbing up to there and even the crux of the pitch is just <Grade system="YDS" value="5.9" />. To be as safe
...
pitch “Universal Key” (<Grade system="YDS" value="5.10b" />) sport style (e.g. get lowered back down to the
...
<Rimg
  src="6.jpg"
  caption="A peculiar balancing boulder. I like the little tree growing on it on the left."
/>
...
<Gallery>
  ...
  <Rimg
    src="5.jpg"
    caption="The chipmunks know, where there are tourists, there will be food"
  />
</Gallery>
