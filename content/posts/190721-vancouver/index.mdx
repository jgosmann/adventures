...
<Loc latlong={[49.6751, -123.15704]} zoom={13} />
...
<Rimg
  src="8.jpg"
  caption="It is always good to be reminded that gravity works. Not that you forget and start flying."
/>
...
<Rimg
  src="14.jpg"
  caption="Selfie because there was no one else here to ask for a photo"
/>
...
<Rimg
  src="16.jpg"
  caption="The first two pitches of Stairway to Heaven. The third climber on the white crack is climbing the trad route Slot Machine."
/>
...
<Rimg
  src="18.jpg"
  caption="First few pitches of Stairway to Heaven on the Chief (I cannot really tell where exactly the later pitches are from this perspective)."
/>
...
<Gallery>
  ...
  <Rimg
    src="25.jpg"
    caption="I have my doubts how original these are, but I will check if there is anything like it at the real Oktoberfest"
  />
