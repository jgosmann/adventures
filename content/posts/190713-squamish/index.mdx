...
<Climbs>
  <Climb name="Oscar's Slab" ascensionStyle="onsight" grade="5.8" />
  <Climb name="Zoë" ascensionStyle="onsight" grade="5.10a" />
  <Climb
    name="More Than Just a Pretty Face"
    ascensionStyle="redpoint"
    grade="5.10c"
  />
  <Climb name="In the Doghouse" ascensionStyle="onsight" grade="5.7" />
  <Climb
    name="A Bachelor's Life Memorial Arête"
    ascensionStyle="flash"
    grade="5.10a"
  />
  <Climb name="Pleasant Pheasant" ascensionStyle="hangdog" grade="5.11a" />
</Climbs>
