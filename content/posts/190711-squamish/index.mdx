...
<Rimg
  src="5.jpg"
  caption="The left line (with climber at the top) is Kigijushi (5.10c). The big roof is the Big Show with some of the hardest routes in Squamish (5.13 upwards)."
/>
...
<Climbs>
  <Climb name="Boy Pie" ascensionStyle="flash" grade="YDS 5.8" />
  <Climb name="Mirror Image" ascensionStyle="flash" grade="YDS 5.8" />
  <Climb name="Kigijushi" ascensionStyle="hangdog" grade="YDS 5.10c" />
  <Multipitch name="Sacrilege" pitches="3">
    <Climb name="pitch 1" ascensionStyle="toprope" grade="YDS 5.8" />
    <Climb name="pitch 2" ascensionStyle="toprope" grade="YDS 5.9" />
    <Climb name="pitch 3" ascensionStyle="onsight" grade="YDS 5.10a" />
  </Multipitch>
  <Climb name="Kingfishers Catch Fire" ascensionStyle="flash" grade="YDS 5.8" />
</Climbs>
