      ...
      <ContentStyleWrapper>
        ...
        <IconBullet icon={faEnvelopeSquare}>
          ...
          <p css={{ opacity: 0.8, fontSize: "0.8em" }}>
            ...
            agree to receive e-mail from this website. For this the e-mail
            address will be stored and processed on the server. You may{" "}
        ...
        <IconBullet icon={faRssSquare}>
          ...
          <ul>
            <li>
              You can use an RSS reader software. You will find lots of choices
              on you favourite search engine. Personally, I use the{" "}
              <a href="http://newsfox.mozdev.org/">
                NewsFox plugin for Firefox
              </a>
              .
            </li>
            <li>
              Many might prefer to get email notifications. Currently, I am not
              offering such a service myself for technical and legal reasons.
              But there are online services that send you email notifications
